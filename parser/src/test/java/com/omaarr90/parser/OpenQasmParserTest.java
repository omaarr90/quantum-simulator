...
class OpenQasmParserTest {
    ...
    void testParseExceptionWithLineColumn() {
        ...
        assertTrue(
                exception.getMessage().contains("Line"), "Error message should contain line info");
    }
    ...
    void testParseExceptionForUndefinedQubit() {
        ...
        assertTrue(
                exception.getMessage().contains("Undefined qubit"),
                "Should mention undefined qubit");
        assertTrue(exception.getLine() > 0, "Should have valid line number");
    ...
    void testParseExceptionForDuplicateRegister() {
        ...
        assertTrue(
                exception.getMessage().contains("already declared"),
                "Should mention duplicate declaration");
        assertEquals(3, exception.getLine(), "Should point to line 3");
        assertNotNull(exception.getSuggestion(), "Should have helpful suggestion");
        assertTrue(
                exception.getSuggestion().contains("different register name"),
                "Should suggest using different name");
    }
