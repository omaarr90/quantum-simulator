...
/**
 * Immutable representation of a quantum gate application.
 * This sealed interface represents operations that can be applied in a quantum circuit.
 */
public sealed interface GateOp permits GateOp.Gate, GateOp.Barrier {
    
    /**
     * Represents a quantum gate application with specific qubits and optional parameters.
     * Gate matrix is looked up via GateType when needed (lazy).
     * 
    ...
    /**
     * Represents a barrier operation for visual/logical separation in the circuit.
     * Barriers do not affect the quantum computation but provide structure.
     * 
