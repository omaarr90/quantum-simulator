 ...
 * 
 * <p>These tests verify that the simulation engines can correctly execute
 * quantum circuits and produce expected measurement outcomes.
 */
class BellCircuitTest {
    ...
    void testBellCircuitWithStatevectorEngine() {
        ...
        Circuit bellCircuit = CircuitBuilder.of(2)
                .h(0)
                .cx(0, 1)
                .measureAll()
                .build();
        ...
        assertTrue(outcome.equals("00") || outcome.equals("11"), 
    ...
    void testBellCircuitMultipleRuns() {
        ...
        assertTrue(Math.abs(actualRatio - expectedRatio) < tolerance,
            String.format("Distribution should be roughly balanced. Got %.2f, expected %.2f ± %.2f",
    ...
    void testSimpleHadamardCircuit() {
        ...
        Circuit hadamardCircuit = CircuitBuilder.of(1)
                .h(0)
                .measureAll()
                .build();
        ...
        String outcome = counts.keySet().iterator().next();
        assertTrue(outcome.equals("0") || outcome.equals("1"),
    ...
    void testIdentityCircuit() {
        ...
        Circuit identityCircuit = CircuitBuilder.of(2)
                .measureAll()
                .build();
