...
public class ParseException extends Exception {
     ...
     */
    public ParseException(String message, int line, int column, String offendingSymbol, String suggestion) {
     ...
     * @param cause the cause of this exception
     */
    public ParseException(String message, int line, int column, String offendingSymbol, String suggestion, Throwable cause) {
    ...
    private static String formatMessage(String message, int line, int column, String offendingSymbol, String suggestion) {
