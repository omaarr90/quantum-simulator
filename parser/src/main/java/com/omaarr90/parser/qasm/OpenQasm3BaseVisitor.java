...
/**
 * This class provides an empty implementation of {@link OpenQasm3Visitor}, which can be extended to
...
public class OpenQasm3BaseVisitor<T> extends AbstractParseTreeVisitor<T>
        implements OpenQasm3Visitor<T> {
    /**
     * {@inheritDoc}
     *
     ...
     */
    @Override
    public T visitProgram(OpenQasm3Parser.ProgramContext ctx) {
     ...
     */
    @Override
    public T visitStatementLine(OpenQasm3Parser.StatementLineContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitVersion(OpenQasm3Parser.VersionContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitStatement(OpenQasm3Parser.StatementContext ctx) {
        return visitChildren(ctx);
    }
