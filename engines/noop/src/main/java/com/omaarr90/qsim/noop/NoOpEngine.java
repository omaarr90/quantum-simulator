 ...
 * 
 * <p>This engine performs no actual simulation and always returns an empty result
 * with zero shots and no measurement outcomes. It is useful for testing, benchmarking,
 * or as a placeholder when no simulation is needed.
 * 
