...
/**
 * Parser for OpenQASM 3 quantum circuits.
 * Converts OpenQASM 3 source code into immutable Circuit objects.
 */
public class OpenQasmParser {
    ...
    private static class ThrowingErrorListener extends BaseErrorListener {
        ...
        public void syntaxError(Recognizer<?, ?> recognizer, Object offendingSymbol,
            ...
            throw new RuntimeException(new ParseException("Syntax error at line " + line + ":" + charPositionInLine + " - " + msg, e));
        }
    }
}