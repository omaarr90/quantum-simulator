 ...
 * <p>
 * This class provides a safe way to share complex array data without allowing
 * modifications. All mutation operations are not available, preventing accidental
 * modifications to the underlying data.
 * </p>
 * <p>
 * <strong>THREAD SAFETY:</strong> This class is not thread-safe. External synchronization
 * is required if instances are accessed concurrently from multiple threads.
 * </p>
 */
