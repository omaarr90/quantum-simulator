...
/**
 * Comprehensive tests for CircuitBuilder DSL. Covers all acceptance tests from the requirements.
 */
class CircuitBuilderTest {
    ...
    class ValidationTest {
        ...
        void duplicateMeasurementThrowsException() {
            ...
            var exception =
                    assertThrows(IllegalArgumentException.class, () -> builder.measure(0, 1));
    ...
    class GateOperationsTest {
        ...
        void multiQubitGates() {
            var circuit = CircuitBuilder.of(3).cx(0, 1).cz(1, 2).swap(0, 2).build();
    ...
    class ClassicalControlsTest {
        ...
        void cIfValidatesParameters() {
            ...
            var exception1 =
                    assertThrows(
                            IllegalArgumentException.class, () -> builder.cIf(-1, 0, b -> b.x(0)));
            assertTrue(exception1.getMessage().contains("cannot be negative"));

            // Invalid value
            var exception2 =
                    assertThrows(
                            IllegalArgumentException.class, () -> builder.cIf(0, 2, b -> b.x(0)));
    ...
    class BarrierTest {
        ...
        void fullBarrier() {
            var circuit = CircuitBuilder.of(3).h(0).barrier().x(1).build();
        ...
        void partialBarrier() {
            var circuit = CircuitBuilder.of(3).h(0).barrier(0, 2).x(1).build();
        ...
        void barrierValidatesQubits() {
            ...
            var exception =
                    assertThrows(IllegalArgumentException.class, () -> builder.barrier(0, 3));
    ...
    class MeasurementTest {
        ...
        void individualMeasurements() {
            var circuit = CircuitBuilder.of(3).h(0).measure(0, 0).measure(2, 1).build();
        ...
        void measureAllWorks() {
            var circuit = CircuitBuilder.of(3).h(0).measureAll().build();
    ...
    class BuilderPropertiesTest {
        ...
        void builderIsChainable() {
            ...
            var circuit = CircuitBuilder.of(2).h(0).x(1).cx(0, 1).barrier().measureAll().build();
        ...
        void builderHelperMethods() {
            var builder = CircuitBuilder.of(3).h(0).cx(0, 1).measure(0, 0);
        ...
        void circuitIsImmutable() {
            var circuit = CircuitBuilder.of(2).h(0).measureAll().build();
            ...
            assertThrows(UnsupportedOperationException.class, () -> circuit.measureMap().put(1, 1));
        }
        ...
        void negativeQubitCountThrowsException() {
            var exception =
                    assertThrows(IllegalArgumentException.class, () -> CircuitBuilder.of(-1));
            assertTrue(exception.getMessage().contains("cannot be negative"));
        }
        ...
        void builderResetClearsState() {
            var builder = CircuitBuilder.of(3).h(0).s(1).cx(0, 1).measure(0, 0).measure(1, 2);
            ...
            var circuit2 = builder.x(2).tdg(1).measure(2, 0).build();
    ...
    class EdgeCasesTest {
        ...
        void singleQubitCircuit() {
            var circuit = CircuitBuilder.of(1).h(0).measure(0, 0).build();
